...
def main():
    fig_path = 'output/synthetic/figs/exp_chunk/'
    try:
        os.makedirs(fig_path)
    except OSError:
        pass

    data_path = 'output/synthetic/exp_chunk/n9_a10_u10000/'

    optimizers = [
        # {'label': 'Cloud', 'x': [
        #     {'id': 'CloudOptimizer', 'x': 0.10},
        #     {'id': 'CloudOptimizer', 'x': 0.25},
        #     {'id': 'CloudOptimizer', 'x': 0.50},
        #     {'id': 'CloudOptimizer', 'x': 1.00},
        # ]},
        # {'label': 'GS', 'x': [
        #     {'id': 'LLCOptimizer_sga_w1_c10', 'x': 0.10},
        #     {'id': 'LLCOptimizer_sga_w1_c25', 'x': 0.25},
        #     {'id': 'LLCOptimizer_sga_w1_c50', 'x': 0.50},
        #     {'id': 'LLCOptimizer_sga_w1_c100', 'x': 1.00},
        # ]},
        # {'label': 'SS', 'x': [
        #     {'id': 'LLCOptimizer_ssga_w1_c10', 'x': 0.10},
        #     {'id': 'LLCOptimizer_ssga_w1_c25', 'x': 0.25},
        #     {'id': 'LLCOptimizer_ssga_w1_c50', 'x': 0.50},
        #     {'id': 'LLCOptimizer_ssga_w1_c100', 'x': 1.00},
        # ]},
        {'label': 'H1', 'x': [
            {'id': 'MOGAOptimizer_c10', 'x': 0.10},
            {'id': 'MOGAOptimizer_c25', 'x': 0.25},
            {'id': 'MOGAOptimizer_c50', 'x': 0.50},
            {'id': 'MOGAOptimizer_c100', 'x': 1.00},
        ]},
    ]

    # x_label = 'Load chunk'
    x_label = r'Load Chunk $\lambda_\%$'
    metrics = [
        {'id': 'weighted_avg_deadline_violation',
         ...
         'legend': False,
         # 'legend_pos': (0.5, 0.5),
         'fig_file': os.path.join(fig_path, 'fig_chunk_dv.png')
         },
        {'id': 'overall_cost',
         ...
         'legend': False,
         # 'legend_pos': (0.5, 0.3),
         'fig_file': os.path.join(fig_path, 'fig_chunk_oc.png')
         },
        {'id': 'weighted_migration_rate',
         ...
         'legend': False,
         # 'legend_pos': (0.5, 0.2),
         'fig_file': os.path.join(fig_path, 'fig_chunk_mc.png')
         },
        {'id': 'elapsed_time',
         ...
         'legend': False,
         # 'legend_pos': (0.5, 0.2),
         'fig_file': os.path.join(fig_path, 'fig_chunk_et.png')
         },
    ]
