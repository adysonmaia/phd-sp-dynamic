...
from .calc import calc_response_time, calc_processing_delay, calc_network_delay, calc_initialization_delay, \
    calc_migration_delay, calc_min_migration_delay, calc_app_size, \
